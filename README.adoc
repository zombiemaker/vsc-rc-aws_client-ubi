...
. Create a folder for a new workspace using Windows Explorer
...
* Fixed .postCreateCommandMarker issue - added bash completion for aws CLI, eksctl CLI, kubectl CLI